...
{
	public class ConfirmOtpViewModel : AppViewModel
	{
		...
		public ConfirmOtpViewModel()
		{
			...
			PhoneNumber = FormatPhoneNumberWithX(PhoneNumber);

			NumberOfSecondsRemaining = 60;

			ResendText = "Get another code in (60) sec";
		...
		public void UpdateResendSeconds(object state)
		{
			try
			{
				...
				ResendText = $"Get another code in ({NumberOfSecondsRemaining}) secs";
