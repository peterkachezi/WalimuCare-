	...
	public class UserProfileViewModel : AppViewModel
	{
		...
		public async void SetData()
		{
			try
			{
				...
				IdNumber = Preferences.Get(nameof(AspNetUsers.idNumber), "");
				SchoolName = Preferences.Get(nameof(AspNetUsers.station), "");
				NhifNo = Preferences.Get(nameof(AspNetUsers.nhifNo), "");
				PostalAddress = Preferences.Get(nameof(AspNetUsers.postal_address), "");
				CountyOfResidence = Preferences.Get(nameof(AspNetUsers.county), "");
				JobGroup = Preferences.Get(nameof(AspNetUsers.jobGroup), "");
				MemberId = Guid.Parse(Preferences.Get(nameof(AspNetUsers.memberId), ""));
				//Gender = Preferences.Get(nameof(AspNetUsers.Gender), "3");
				//DateOfBirth = Preferences.Get(nameof(AspNetUsers.DateOfBirth), "DateOfBirth");
